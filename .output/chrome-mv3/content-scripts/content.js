var content=(function(){var e=Object.create,t=Object.defineProperty,n=Object.getOwnPropertyDescriptor,r=Object.getOwnPropertyNames,i=Object.getPrototypeOf,a=Object.prototype.hasOwnProperty,o=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports),s=(e,i,o,s)=>{if(i&&typeof i==`object`||typeof i==`function`)for(var c=r(i),l=0,u=c.length,d;l<u;l++)d=c[l],!a.call(e,d)&&d!==o&&t(e,d,{get:(e=>i[e]).bind(null,d),enumerable:!(s=n(i,d))||s.enumerable});return e},c=(n,r,a)=>(a=n==null?{}:e(i(n)),s(r||!n||!n.__esModule?t(a,`default`,{value:n,enumerable:!0}):a,n));function l(e){return e}var u=class{constructor(e){if(e===`<all_urls>`)this.isAllUrls=!0,this.protocolMatches=[...u.PROTOCOLS],this.hostnameMatch=`*`,this.pathnameMatch=`*`;else{let t=/(.*):\/\/(.*?)(\/.*)/.exec(e);if(t==null)throw new f(e,`Incorrect format`);let[n,r,i,a]=t;p(e,r),m(e,i),this.protocolMatches=r===`*`?[`http`,`https`]:[r],this.hostnameMatch=i,this.pathnameMatch=a}}includes(e){if(this.isAllUrls)return!0;let t=typeof e==`string`?new URL(e):e instanceof Location?new URL(e.href):e;return!!this.protocolMatches.find(e=>{if(e===`http`)return this.isHttpMatch(t);if(e===`https`)return this.isHttpsMatch(t);if(e===`file`)return this.isFileMatch(t);if(e===`ftp`)return this.isFtpMatch(t);if(e===`urn`)return this.isUrnMatch(t)})}isHttpMatch(e){return e.protocol===`http:`&&this.isHostPathMatch(e)}isHttpsMatch(e){return e.protocol===`https:`&&this.isHostPathMatch(e)}isHostPathMatch(e){if(!this.hostnameMatch||!this.pathnameMatch)return!1;let t=[this.convertPatternToRegex(this.hostnameMatch),this.convertPatternToRegex(this.hostnameMatch.replace(/^\*\./,``))],n=this.convertPatternToRegex(this.pathnameMatch);return!!t.find(t=>t.test(e.hostname))&&n.test(e.pathname)}isFileMatch(e){throw Error(`Not implemented: file:// pattern matching. Open a PR to add support`)}isFtpMatch(e){throw Error(`Not implemented: ftp:// pattern matching. Open a PR to add support`)}isUrnMatch(e){throw Error(`Not implemented: urn:// pattern matching. Open a PR to add support`)}convertPatternToRegex(e){let t=this.escapeForRegex(e).replace(/\\\*/g,`.*`);return RegExp(`^${t}$`)}escapeForRegex(e){return e.replace(/[.*+?^${}()|[\]\\]/g,`\\$&`)}},d=u;d.PROTOCOLS=[`http`,`https`,`file`,`ftp`,`urn`];var f=class extends Error{constructor(e,t){super(`Invalid match pattern "${e}": ${t}`)}};function p(e,t){if(!d.PROTOCOLS.includes(t)&&t!==`*`)throw new f(e,`${t} not a valid protocol (${d.PROTOCOLS.join(`, `)})`)}function m(e,t){if(t.includes(`:`))throw new f(e,`Hostname cannot include a port`);if(t.includes(`*`)&&t.length>1&&!t.startsWith(`*.`))throw new f(e,`If using a wildcard (*), it must go at the start of the hostname`)}function h(e){if(!e)return``;try{return new URL(e).hostname.replace(/^www\./,``)}catch{return``}}var g={length:20,uppercase:!0,lowercase:!0,numbers:!0,symbols:!0},_=[`user`,`email`,`login`];function v(e){if(e.type===`email`)return!0;let t=e.getAttribute(`autocomplete`)||``,n=e.name.toLowerCase(),r=e.id.toLowerCase(),i=(e.placeholder||``).toLowerCase();return _.some(e=>t.includes(e)||n.includes(e)||r.includes(e)||i.includes(e))}var y=l({matches:[`<all_urls>`],allFrames:!0,main(){let e=null,t=null,n=null,r=0,i=null,a=null,o=5e3,s={darkBg:`#1A1A1A`,darkerBg:`#0D0D0D`,hoverBg:`#2A2A2A`,cardBg:`#333333`,textPrimary:`#FFFFFF`,textSecondary:`#737373`,textMuted:`#525252`,gold:`#C98700`,green:`#00FF88`,border:`rgba(255,255,255,0.1)`,borderSubtle:`rgba(255,255,255,0.05)`};async function c(e,t,n=null){try{let r=await chrome.runtime.sendMessage(t===void 0?{type:e}:{type:e,payload:t});return r.success?r.data:n}catch{return n}}async function l(){let e=Date.now();if(i&&e-i.timestamp<o)return i.data;let t=await c(`GET_VAULT_STATE`);return i={data:t,timestamp:e},t}async function u(e){let t=Date.now();if(a&&a.url===e&&t-a.timestamp<o)return a.data;let n=await c(`GET_ENTRY_BY_URL`,e);return a={url:e,data:n,timestamp:t},n}let d=h;function f(e){e.dispatchEvent(new Event(`input`,{bubbles:!0})),e.dispatchEvent(new Event(`change`,{bubbles:!0}))}function p(e){let{length:t,uppercase:n,lowercase:r,numbers:i,symbols:a}=e,o=``;if(r&&(o+=`abcdefghijklmnopqrstuvwxyz`),n&&(o+=`ABCDEFGHIJKLMNOPQRSTUVWXYZ`),i&&(o+=`0123456789`),a&&(o+=`!@#$%^&*`),o.length===0)return``;let s=256-256%o.length,c=``;for(;c.length<t;){let e=new Uint8Array(32);crypto.getRandomValues(e);for(let n=0;n<e.length&&c.length<t;n++)e[n]<s&&(c+=o.charAt(e[n]%o.length))}return c}function m(t,n){if(e&&e.remove(),t.length===0)e=document.createElement(`div`),e.innerHTML=`
        ...
        `;let a=document.createElement(`span`);a.textContent=`Nemo Password Manager`;let o=document.createElement(`span`);o.style.cssText=`font-size: 12px; color: #737373; font-weight: 400;`,o.textContent=`${t.length} entries`,i.appendChild(a),i.appendChild(o),r.appendChild(i),t.forEach(e=>{let t=document.createElement(`div`);t.className=`nemo-entry-item`,t.style.cssText=`
          ...
          `,t.appendChild(l),t.addEventListener(`mouseenter`,()=>{t.style.background=s.hoverBg}),t.addEventListener(`mouseleave`,()=>{t.style.background=`transparent`}),t.addEventListener(`click`,()=>{n(e),y()}),r.appendChild(t)}),e.appendChild(r)}document.body.appendChild(e),_()}function _(){if(!e||!n)return;let t=e.querySelector(`div`);if(!t)return;let r=n.getBoundingClientRect(),i=window.innerHeight,a=window.innerWidth,o=r.bottom+8,s=a-r.right;o+400>i&&(o=r.top-400-8),s<16&&(s=16),t.style.position=`fixed`,t.style.top=`${o}px`,t.style.right=`${s}px`}function y(){e&&=(e.remove(),null)}function b(){t&&=(t.remove(),null)}function x(e){b();let n={...g},r=``;t=document.createElement(`div`),t.innerHTML=`
      ...
      `,document.body.appendChild(t);let i=t.querySelector(`#nemo-generator-panel`),a=e.getBoundingClientRect();i.style.top=`${a.bottom+8+window.scrollY}px`,i.style.left=`${a.left+window.scrollX}px`;let o=i.querySelector(`#nemo-gen-length`),l=i.querySelector(`#nemo-gen-length-val`),u=i.querySelector(`#nemo-gen-preview`),d=i.querySelector(`#nemo-gen-btn`),m=i.querySelector(`#nemo-gen-fill`),h=()=>{n.length=parseInt(o.value),n.uppercase=i.querySelector(`#nemo-gen-upper`).checked,n.lowercase=i.querySelector(`#nemo-gen-lower`).checked,n.numbers=i.querySelector(`#nemo-gen-numbers`).checked,n.symbols=i.querySelector(`#nemo-gen-symbols`).checked,l.textContent=String(n.length)},_=()=>{if(h(),!n.uppercase&&!n.lowercase&&!n.numbers&&!n.symbols){u.textContent=`Select at least one type`,u.style.color=`#FF6B6B`,m.disabled=!0;return}r=p(n),u.textContent=r,u.style.color=s.green,m.disabled=!1};o.addEventListener(`input`,()=>{l.textContent=o.value}),i.querySelectorAll(`input[type="checkbox"]`).forEach(e=>{e.addEventListener(`change`,h)}),d.addEventListener(`click`,_),m.addEventListener(`click`,async()=>{if(!r)return;e.value=r,f(e);let t=S();await c(`ADD_ENTRY`,{title:window.location.hostname,username:t||void 0,password:r,url:window.location.href}),b()}),_()}function S(){for(let e of[`input[type="email"]`,`input[name*="user" i]`,`input[name*="email" i]`,`input[id*="user" i]`,`input[id*="email" i]`]){let t=document.querySelector(e);if(t?.value)return t.value}return null}function C(e,t,n){let r=n?.closest(`form`)||document;r.querySelectorAll(`input[type="text"], input[type="email"]`).forEach(t=>{t instanceof HTMLInputElement&&v(t)&&(t.value=e,f(t))}),r.querySelectorAll(`input[type="password"]`).forEach(e=>{e instanceof HTMLInputElement&&(e.value=t,f(e))})}function w(e,t,n){e.addEventListener(`mouseenter`,()=>{e.style.background=n,e.style.transform=`scale(1.05)`}),e.addEventListener(`mouseleave`,()=>{e.style.background=t,e.style.transform=`scale(1)`})}function T(e){cancelAnimationFrame(r),r=requestAnimationFrame(e)}function E(r){if(!r.parentElement||r.dataset.nemoButton)return;r.dataset.nemoButton=`true`;let i=document.createElement(`button`);i.type=`button`,i.dataset.nemoAction=`fill`,i.innerHTML=`
      ...
      `,a.style.cssText=`
        ...
        opacity: 0;
        pointer-events: none;
      `;let o=()=>{let e=r.getBoundingClientRect(),t=window.scrollX,n=window.scrollY;i.style.left=`${e.right-36+t}px`,i.style.top=`${e.top+(e.height-28)/2+n}px`,a.style.left=`${e.right-72+t}px`,a.style.top=`${e.top+(e.height-28)/2+n}px`},l=()=>T(o);o(),window.addEventListener(`scroll`,l,{passive:!0}),window.addEventListener(`resize`,l),document.body.appendChild(i),document.body.appendChild(a),w(i,s.darkBg,s.cardBg),w(a,s.cardBg,`#444`),i.addEventListener(`click`,async t=>{if(t.preventDefault(),t.stopPropagation(),n=r,b(),!(await c(`GET_VAULT_STATE`))?.isUnlocked){chrome.runtime.sendMessage({type:`OPEN_POPUP`});return}if(e){y();return}m(await c(`GET_ENTRIES_FOR_AUTOFILL`,void 0,[]),e=>{C(e.username,e.password,r)})}),a.addEventListener(`click`,async e=>{if(e.preventDefault(),e.stopPropagation(),y(),!(await c(`GET_VAULT_STATE`))?.isUnlocked){chrome.runtime.sendMessage({type:`OPEN_POPUP`});return}if(t){b();return}n=r,x(r)}),r.addEventListener(`focus`,()=>{n=r,l(),a.style.opacity=`1`,a.style.pointerEvents=`auto`}),r.addEventListener(`blur`,()=>{setTimeout(()=>{!a.matches(`:hover`)&&!i.matches(`:hover`)&&(a.style.opacity=`0`,a.style.pointerEvents=`none`)},200)});let u=()=>{l(),i.style.opacity=`1`,i.style.pointerEvents=`auto`,a.style.opacity=r===document.activeElement?`1`:`0`,a.style.pointerEvents=r===document.activeElement?`auto`:`none`},d=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?u():(i.style.opacity=`0`,a.style.opacity=`0`)})},{threshold:.5});d.observe(r);let f=()=>{i.remove(),a.remove(),d.disconnect(),window.removeEventListener(`scroll`,l),window.removeEventListener(`resize`,l)},p=new MutationObserver(()=>{r.isConnected||(f(),p.disconnect())});p.observe(document.body,{childList:!0,subtree:!0}),u()}let D=null;function O(){document.querySelectorAll(`input[type="password"]:not([data-nemo-button])`).forEach(e=>{e instanceof HTMLInputElement&&E(e)}),document.querySelectorAll(`input[type="text"]:not([data-nemo-button]), input[type="email"]:not([data-nemo-button])`).forEach(e=>{e instanceof HTMLInputElement&&v(e)&&E(e)})}setTimeout(O,1e3),new MutationObserver(()=>{D||=setTimeout(()=>{D=null,O()},200)}).observe(document.body,{childList:!0,subtree:!0}),document.addEventListener(`click`,e=>{let t=e.target;!t.closest(`#nemo-autofill-overlay`)&&!t.closest(`#nemo-generator-panel`)&&(y(),b())}),document.addEventListener(`focusin`,async t=>{let r=t.target;if((r.type===`password`||r.type===`text`||r.type===`email`)&&(n=r,(await l())?.isUnlocked&&!e)){let e=await u(window.location.href);if(e){let t=d(window.location.href),r=t?await c(`GET_SITE_PREFERENCES`,t):null;if(r?.autoFillMode===`never`)return;r?.autoFillMode===`always`&&r.preferredEntryId===e.id&&C(e.username,e.password,n??void 0)}}});let k=null;function A(e){let t=e.querySelectorAll(`input[type="password"]`);if(t.length===0)return!1;let n=Array.from(t).some(e=>{let t=e,n=t.getAttribute(`autocomplete`)||``,r=t.name.toLowerCase(),i=t.id.toLowerCase();return n===`new-password`||r.includes(`confirm`)||r.includes(`verify`)||i.includes(`confirm`)||i.includes(`verify`)}),r=e.querySelectorAll(`button[type="submit"], input[type="submit"]`),i=Array.from(r).some(e=>{let t=(e.textContent||e.getAttribute(`value`)||``).toLowerCase();return t.includes(`sign up`)||t.includes(`signup`)||t.includes(`create`)||t.includes(`register`)||t.includes(`join`)||t.includes(`get started`)});return n||i}function j(e){let t=e.querySelectorAll(`input[type="password"]`),n=``;for(let e of t){let t=e;t.value&&(!n||t.name.toLowerCase().includes(`password`))&&(n=t.value)}return{username:S()||``,password:n,title:window.location.hostname}}function M(e){k&&k.remove();let t=document.createElement(`div`);t.id=`nemo-quick-add-banner`,t.innerHTML=`
        <div style="
          position: fixed;
          top: 0;
          left: 0;

...
const BIP39_WORDLIST = [
  ...
  "boil", "bomb", "bone", "bonus", "book", "boost", "border", "bored", "borrow", "boss",
  ...
  "react", "read", "real", "realm", "reason", "rebuilt", "recall", "receipt", "receive", "recipe",
  "recite", "reckon", "record", "recycle", "red", "reduce", "reefer", "referee", "reflect", "region",
  "regret", "regular", "reject", "relax", "release", "relief", "rely", "remain", "remember", "remind",
  "remote", "remove", "render", "renew", "rent", "reopen", "repair", "repeat", "replace", "reply",
  "report", "represent", "reptile", "require", "rescue", "resemble", "resist", "resource", "response", "result",
